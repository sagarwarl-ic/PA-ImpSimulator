USE [ImpactSimulator]
GO
/****** Object:  StoredProcedure [dbo].[MenuitemSelectProc_1]    Script Date: 12/20/2019 1:07:08 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER   PROCEDURE [dbo].[CompareScenario] 
@Project_Id bigint=0,
@BrandId int=0
AS
BEGIN
...
FROM (
  ...
  [Custom SQL Query].Scenario_Id_Product
    ...
    [IST_Store_Product_Info].Project_Id=[IST_Store_Info].Project_Id and 
