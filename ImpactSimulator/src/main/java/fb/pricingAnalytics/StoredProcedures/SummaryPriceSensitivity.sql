USE [ImpactSimulator]
GO
/****** Object:  StoredProcedure [dbo].[SummaryPriceSensitivity_NEW]    Script Date: 4/24/2020 2:22:40 AM ******/
SET ANSI_NULLS ON
GO
...
) [Custom SQL Query] where  BrandId=@BrandId and DataEntryId =@DataEntryId
and Project_Id=@Project_Id  
and Scenario_ID_Store =@Scenario_Id 
GROUP BY ()
) [t1])
