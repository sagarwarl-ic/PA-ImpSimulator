 ...
 * 2019-10-22T10:54:04.131+05:30
 * Generated source version: 2.7.0
 * 
 */
@WebServiceClient(name = "FishbowlSSO", 
                  wsdlLocation = "file:/Applications/XAMPP/xamppfiles/htdocs/FishbowlRepos/PA-ImpSimulator/ImpactSimulator/src/main/resources/wsdl/fishbowlsso.wsdl",
...
public class FishbowlSSO extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Applications/XAMPP/xamppfiles/htdocs/FishbowlRepos/PA-ImpSimulator/ImpactSimulator/src/main/resources/wsdl/fishbowlsso.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FishbowlSSO.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Applications/XAMPP/xamppfiles/htdocs/FishbowlRepos/PA-ImpSimulator/ImpactSimulator/src/main/resources/wsdl/fishbowlsso.wsdl");
        }
        WSDL_LOCATION = url;
    }
